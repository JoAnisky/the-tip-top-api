 ...
 */
final class Version20250822140139 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE social_account (id INT AUTO_INCREMENT NOT NULL, provider_name VARCHAR(255) NOT NULL, provider_id INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    }
